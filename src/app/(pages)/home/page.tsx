...
export default function Home() {
  const banners1 = [profilePic1, profilePic2];
  ...
  return (
    <>
      ...
      <section className="w-full h-full mt-5">
        ...
        <CarouselDemo images={banners1} classNames="basis-5/6 px-3 rounded-md" />
      </section>
      ...
      <section className="w-full h-full mt-10">
        ...
        <CarouselDemo images={banners2} classNames="basis-5/6 px-3 rounded-md" />
      </section>
    </>
  );
}
